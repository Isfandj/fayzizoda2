...
function wp_bootstrap_starter_setup() {
	...
	register_nav_menus( array(
		...
		'foot-menu' => esc_html__( 'Footer', 'wp-bootstrap-starter' ),
...
add_theme_support( 'product', array(
			'height'      => 205,
			'width'       => 150,
			'flex-width'  => true,
			'flex-height' => true,
...
function wp_bootstrap_starter_scripts() {
    ...
    wp_enqueue_style( 'animate-header', get_template_directory_uri() . '/css/animated-header.css' );
	...
	/****************************************************/
	wp_enqueue_script('custom-script', get_template_directory_uri() .'/js/script.js', array(), '', true );
   wp_enqueue_script('counterup', get_template_directory_uri() .'/js/jquery.counterup.min.js', array(), '', true );
    ...
    wp_enqueue_script('smoth-scroll', get_template_directory_uri() .'/js/smooth-scroll.min.js', array(), '', true );
    wp_enqueue_script('wow-js', get_template_directory_uri() .'/js/wow-1.3.0.min.js', array(), '', true );
    ...
    wp_enqueue_script('cbpAnimatedHeader', get_template_directory_uri() .'/js/cbpAnimatedHeader.min.js', array(), '', true );
...
$button_text = __("Order now", "woocommerce");
$button_link = $product->get_permalink();
$button = '<a class="btn chipsofic-small-btn" href="' . $button_link . '">' . $button_text . '</a>';
return $button;
}
}
